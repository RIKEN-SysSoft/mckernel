...
extern void arch_unhandled_page_fault_prologue(struct thread *thread, void *fault_addr, uint64_t reason, void *regs);
extern void arch_unhandled_page_fault_epilogue(struct thread *thread, void *fault_addr, uint64_t reason, void *regs);
...
static void unhandled_page_fault(struct thread *thread, void *fault_addr, uint64_t reason, void *regs)
{
	...
	arch_unhandled_page_fault_epilogue(thread, fault_addr, reason, regs);
