...
static inline int arch_cpu_mrs(uint32_t sys_reg, uint64_t *val)
{
	...
	switch (sys_reg) {
		...
		SYSREG_READ_S(IMP_FJ_TAG_ADDRESS_CTRL_EL2);
		SYSREG_READ_S(IMP_FJ_TAG_ADDRESS_CTRL_EL3);
		SYSREG_READ_S(IMP_FJ_TAG_ADDRESS_CTRL_EL12);
		...
		SYSREG_READ_S(IMP_SCCR_VSCCR_L2_EL0);
		...
		SYSREG_READ_S(IMP_BARRIER_LBSY_SYNC_W0_EL0);
		SYSREG_READ_S(IMP_BARRIER_LBSY_SYNC_W1_EL0);
		SYSREG_READ_S(IMP_BARRIER_LBSY_SYNC_W2_EL0);
		SYSREG_READ_S(IMP_BARRIER_LBSY_SYNC_W3_EL0);
		SYSREG_READ_S(IMP_SOC_STANDBY_CTRL_EL1);
		SYSREG_READ_S(IMP_FJ_MCR_EL3);
...
static inline int arch_cpu_msr(uint32_t sys_reg, uint64_t val)
{
	...
	switch (sys_reg) {
		...
		SYSREG_WRITE_S(IMP_FJ_TAG_ADDRESS_CTRL_EL2);
		SYSREG_WRITE_S(IMP_FJ_TAG_ADDRESS_CTRL_EL3);
		SYSREG_WRITE_S(IMP_FJ_TAG_ADDRESS_CTRL_EL12);
		...
		SYSREG_WRITE_S(IMP_SCCR_VSCCR_L2_EL0);
		...
		SYSREG_WRITE_S(IMP_BARRIER_BST_SYNC_W0_EL0);
