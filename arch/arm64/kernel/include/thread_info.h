...
#define MIN_KERNEL_STACK_SHIFT	(14 + KASAN_THREAD_SHIFT)

#if (MIN_KERNEL_STACK_SHIFT < LINUX_PAGE_SHIFT)
#define KERNEL_STACK_SHIFT	LINUX_PAGE_SHIFT
#else
...
#endif
#define KERNEL_STACK_SHIFT       (LINUX_PAGE_SHIFT + 2 + KASAN_STACK_ORDER)
#endif
