...
# define CONT_PAGE_SHIFT         4
# define CONT_LARGE_PAGE_SHIFT   4
# define CONT_LARGEST_PAGE_SHIFT 4
#elif 0
# error 16KB granule size not supported.
# define PAGE_SHIFT        14 //16KB
# define CONT_PAGE_SHIFT         7
# define CONT_LARGE_PAGE_SHIFT   5
# define CONT_LARGEST_PAGE_SHIFT 0
#else
# define PAGE_SHIFT        16 //64KB
# define CONT_PAGE_SHIFT         5
# define CONT_LARGE_PAGE_SHIFT   5
# define CONT_LARGEST_PAGE_SHIFT 5
#endif
