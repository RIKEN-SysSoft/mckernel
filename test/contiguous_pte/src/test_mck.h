...
#define CONT_PAGE_SIZE    (1UL << (PAGE_SHIFT + CONT_PAGE_SHIFT))
...
#define CONT_LARGE_PAGE_SIZE    (1UL << (LARGE_PAGE_SHIFT + CONT_LARGE_PAGE_SHIFT))
...
#define CONT_LARGEST_PAGE_SIZE    (1UL << (LARGEST_PAGE_SHIFT + CONT_LARGEST_PAGE_SHIFT))
